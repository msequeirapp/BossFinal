...
>>>>>>> 79a8b376af99b1a219e0288a23002118e200809b
  ...
  es: {
    ...
    services: {
      ...
      production: "Grabación de Voz",
      productionDesc: "Grabación vocal profesional con equipos de última generación.",
      distribution: "Master y Mezcla",
      distributionDesc: "Masterización y mezcla experta para perfeccionar tu sonido.",
      development: "Coach Vocal",
      developmentDesc: "Orientación profesional para mejorar tu técnica vocal y rendimiento.",
      publishing: "Composición de Canciones",
      publishingDesc: "Servicios de composición colaborativa para dar vida a tus ideas musicales.",
      licensing: "Sesiones de Estudio",
      licensingDesc: "Sesiones completas de estudio con equipos profesionales e ingenieros experimentados.",
